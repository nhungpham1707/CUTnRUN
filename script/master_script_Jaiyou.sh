...
#SBATCH --output=five_steps_jaiyou_withufc.out
#SBATCH --time=96:0:0
#SBATCH --ntasks=1
#SBATCH --mem=10G
...
data_dir=/hpc/pmc_drost/PROJECTS/SMARCB1_reexpression_JH/ATAC/data/ATRT04
# dir for new data 
# data_dir=/hpc/pmc_drost/PROJECTS/swang/CUT_RUN/SCC_ChIC-PMC-DRO_plates_20210520_run1/SCC-bulkChIC-PMC-DRO-020--25/
# result dir
res_dir=/hpc/pmc_drost/PROJECTS/swang/CUT_RUN/nhung_test_jaiyou_sample
