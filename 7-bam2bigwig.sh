...
# Transform bam files to bigwig

# Nhung 22 03 2023

# merge files from the same condition

samtools merge -o ${merged_bigwig}/tfe3_merged.bam ${rm_dup_dir}/SCC-ChIC-PMC-DRO-T1/SCC-ChIC-PMC-DRO-T1_rmdup_filt.bam \
...
samtools merge fusion_merged.bam ${rm_dup_dir}/SCC-ChIC-PMC-DRO-F1/SCC-ChIC-PMC-DRO-F1_rmdup_filt.bam \
