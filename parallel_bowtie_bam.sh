#!/bin/bash
#SBATCH --job-name=paral_bowtiee
#SBATCH --output=paral_all_sample_bowtie2_bam_file.out
#SBATCH --time=96:0:0
#SBATCH --ntasks=3
#SBATCH --mem=40G
...
mkdir -p ${res_dir}/alignment_parallel
align_dir=${res_dir}/alignment_parallel
